...
public interface BasicQueryService {
	 ...
	 * @throws QueryServiceException
	 *             if there is a failure in retrieving all items from the
	 *             database.
	 */
	public List<Item> findAllItems() throws QueryServiceException;

	/**
	 * Finds all items in the database that are of interest for the searching
	 * user.
	 * 
	 * @param user
	 *            the searching user
	 * @return the list of all items that are of interest for the given user.
	 * @throws QueryServiceException
	 *             if there is a failure in retrieving all items from the
	 *             database.
	 */
